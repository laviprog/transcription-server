import transcription_server.worker.db  # noqa
from celery import Celery

from transcription_server.worker import signals  # noqa: F401
...
celery_app.autodiscover_tasks(["transcription_server.worker"])
